...
export default function NewActivityPage({ params }: { params: { id: string } }) {
  ...
  function onSubmit(data: ActivityFormValues) {
    // In a real app, we would save the activity data here
    console.log(data)
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Tokyo Tower" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="4-chome-2-8 Shibakoen, Minato City, Tokyo" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="$10 per person" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
